    ...
    <footer className="border-t bg-card/50">
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-lg font-bold">Future Finance</span>
            </div>
            <p className="text-sm text-muted-foreground max-w-xs">
              AI-powered price predictions and smart budgeting tools to help you
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="https://github.com/Rishita317/future-finance-graphs"
                target="_blank"
              ...
              <a
                href="mailto:contact@futurefinance.com"
                className="flex items-center justify-center h-9 w-9 rounded-md border bg-background hover:bg-accent transition-colors"
              >
            ...
            <p className="text-xs text-muted-foreground mt-4">
              Built with advanced AI models for educational purposes
            </p>
          </div>
        </div>
        ...
        <div className="border-t mt-8 pt-6 text-center text-sm text-muted-foreground">
          <p>
            © 2024 Future Finance. Built with advanced AI models for educational
